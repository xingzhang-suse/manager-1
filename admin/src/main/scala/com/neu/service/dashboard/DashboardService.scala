          ...
          VulnerabilityExploitRisk(
            vulContainerOutput match {
              ...
              case Right(x) =>
                Right(
                  VulnerabilityCount(
                    x.criticalVulsMap.getOrElse(DISCOVER, 0),
            ...
            vulContainerOutput match {
              ...
              case Right(x) =>
                Right(
                  VulnerabilityCount(
                    x.criticalVulsMap.getOrElse(MONITOR, 0),
            ...
            vulContainerOutput match {
              ...
              case Right(x) =>
                Right(
                  VulnerabilityCount(
                    x.criticalVulsMap.getOrElse(PROTECT, 0),
            ...
            vulContainerOutput match {
              ...
              case Right(x) =>
                Right(
                  VulnerabilityCount(
                    x.criticalVulsMap.getOrElse(QUARANTINED, 0),
